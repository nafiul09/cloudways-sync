...
export const ipcClient = {
  ...
  getLocalSite: (req: GetLocalSiteRequest) => invoke<GetLocalSiteResponse>(CHANNELS.GET_LOCAL_SITE, req),
  ...
  preflightCheck: (req: PreflightCheckRequest) => invoke<PreflightCheckResponse>(CHANNELS.PREFLIGHT_CHECK, req),
  upgradeRemoteWp: (req: UpgradeRemoteWpRequest) => invoke<UpgradeRemoteWpResponse>(CHANNELS.UPGRADE_REMOTE_WP, req),
  getSyncLogs: (req: GetSyncLogsRequest) => invoke<GetSyncLogsResponse>(CHANNELS.GET_SYNC_LOGS, req),
  exportSyncLogs: (req: ExportSyncLogsRequest) => invoke<ExportSyncLogsResponse>(CHANNELS.EXPORT_SYNC_LOGS, req),
